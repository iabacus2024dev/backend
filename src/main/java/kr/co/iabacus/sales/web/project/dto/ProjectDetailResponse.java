...
public class ProjectDetailResponse {
    ...
    @Builder
    public ProjectDetailResponse(UUID id, Long teamId, String code, String name, LocalDate contractDate, LocalDate startDate,
                                 ...
                                 String orderingCompanyRep, Phone mainCompanyRepPhone, Phone orderingCompanyRepPhone, String pmName, Phone pmPhone) {
        this.id = id;
        this.teamId = teamId;
        this.code = code;
        this.name = name;
        ...
        this.pmName = pmName;
        this.pmPhone = pmPhone.getNumber();
    }
